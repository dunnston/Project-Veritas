...
signal building_removed(building_id: String, position: Vector2)
...
func emit_building_placed(building_id: String, pos: Vector2) -> void:
	building_placed.emit(building_id, pos)

func emit_building_removed(building_id: String, pos: Vector2) -> void:
