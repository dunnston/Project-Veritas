...
class_name BuildingManagerModule
...
func can_place_building(building_id: String, grid_pos: Vector2) -> bool:
...
func place_building(building_id: String, world_pos: Vector2) -> bool:
...
func remove_building(grid_pos: Vector2) -> bool:
	var pos_key = "%d,%d" % [grid_pos.x, grid_pos.y]
...
func get_building_at(grid_pos: Vector2) -> Dictionary:
	var pos_key = "%d,%d" % [grid_pos.x, grid_pos.y]
	if pos_key in placed_buildings:
...
func update_ghost_building(world_pos: Vector2) -> void:
